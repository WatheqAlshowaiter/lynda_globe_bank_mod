<?php
  ...
  // * spaces count towards length
  // * use trim() if spaces should not count
  // * we use mb_strlen to handle arablic letters correctly
  ...
  // * use mb_strpos for Arabic 
  function has_string($value, $required_string) {
    return mb_strpos($value, $required_string) !== false;
  }
  ...
  // there is some trouble in this function 
